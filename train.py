...
from test_base.tensorflow_captcha.cfg import MAX_CAPTCHA, CHAR_SET_LEN, tb_log_path, save_model,model_path
from test_base.tensorflow_captcha.cnn_sys import crack_captcha_cnn, Y, keep_prob, X
from test_base.tensorflow_captcha.data_iter import get_next_batch
from test_base.tensorflow_captcha.predict import test_hack_captcha_training_data
import time,os
...
def train_crack_captcha_cnn():
    ...
    while True:
        ...
        if step%10==0:
            ...
            #     print('acc_on_train_pic: %0.2f%%' % (acc_train_pic * 100))
            #     break
            # saver.save(sess, save_model, global_step=step)
...
if __name__ == '__main__':
    ...
    gl.set_value('UsedFilePath','E:\\captcha\\used')
